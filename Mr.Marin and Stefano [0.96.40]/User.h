...
struct OBJECTSTRUCT
{
	...
	/*0x8	+ 0x24*/	unsigned char m_Filler0x8[0x24]; // Unknown Bytes
	/*0x2C  +  0x1*/	unsigned char Magumsa; // Magumsa
	/*0x2D  + 0x30*/	unsigned char m_Filler0x2D[0x30];	// 0x32
	/*0x5D  +  0x1*/	unsigned char Live;					// New
	/*0x5E  +  0x1*/	unsigned char Type;					// New
	...
	/*Final 0x0D0C*/
	/* Start PLAYER OBJECT ADD STRUCT */
	char VipLevel;
	char CtlCodeEx;
	char ShopNumberEx;
...
extern OBJECTSTRUCT gObj[OBJECT_END];
